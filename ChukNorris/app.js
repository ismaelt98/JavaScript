...
function fetchChuckNorrisJoke() {
    return __awaiter(this, void 0, void 0, function () {
        var chuckNorrisApiUrl, response, data, jokeElement, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch(chuckNorrisApiUrl)];
                case 2:
                    response = _a.sent();
                    if (!response.ok) {
                ...
                case 3:
                    data = _a.sent();
                    jokeElement = document.getElementById('chuck-norris-joke');
                    if (jokeElement) {
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Error al obtener la broma de Chuck Norris:', error_1);
                    return [3 /*break*/, 5];
...
var getNewJokeButton = document.getElementById('get-new-joke');
if (getNewJokeButton) {
